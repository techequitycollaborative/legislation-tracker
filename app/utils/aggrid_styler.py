...
def draw_bill_grid(
    ...
    builder.configure_columns(['full_text','leginfo_link','coauthors','bill_history','leg_session','bill_id','chamber','event_text'],hide=True) # hide these columns in the initial dataframe
